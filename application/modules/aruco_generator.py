...
class ArucoGenerator():
    ...
    def gen_aruco(self,data):
        generator = aruco.generateImageMarker(self.dictionary,data,100)
        return generator
    
    def put_text_in_image(self,img, text, place = 'bottom', size = 0.3, color = 'white', thickness = 1, margin = 3, bordering = None):
        """
        画像に文字を入れる
    ...
    def generate_marker(self,name,data):
...
if __name__ == '__main__':
    ...
    ar_gen.generate_marker('./marker/test.png',100)